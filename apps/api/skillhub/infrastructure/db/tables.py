...
eval_case_versions = Table(
    ...
    Column("attachment_artifact_id", Text, ForeignKey("artifacts.id")),
    Column("prompt_template_id", Text, nullable=False, server_default=text("'standard_pass_fail'")),
    Column("prompt_text", Text, nullable=False, server_default=text("''")),
    Column("model_provider_id", Text),
...
eval_case_runs = Table(
    ...
    Column("result_artifact_id", Text, ForeignKey("artifacts.id")),
    Column("runner_metadata", JSONB(), nullable=False, server_default=text("'{}'")),
    timestamp_column(),

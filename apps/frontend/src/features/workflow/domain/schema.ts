...
const binding = z.object({ kind: z.string(), reference: z.record(z.string(), z.string()), value: z.unknown().optional() }).strict();
const stepInput = z.object({ parameter, binding: binding.optional() }).strict();
const metadata = z.object({ name: z.string(), code: z.string(), description: z.string(), industry: z.string(), device: z.string(), versions: z.array(z.string()) }).strict();
...
const output = z.object({ id: z.string(), key: z.string(), name: z.string(), description: z.string(), dataType: z.string() }).strict();
...
const baseStep = { id: z.string(), name: z.string(), description: z.string(), isStart: z.boolean(), inputs: z.array(stepInput), collectionCalls: z.array(call), topology: z.array(transition) };

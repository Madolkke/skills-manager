...
const generators: WorkflowSkillGenerator[] = [
  { id: "builtin.single-file", version: "workflow-skill-v4.1.1", label: "单文件（兼容模式）", default: false, options_schema: {} },
  { id: "builtin.three-file", version: "2.1.1", label: "固定三文件", default: true, options_schema: {} },
  { id: "builtin.node-split", version: "2.1.1", label: "按节点拆分", default: false, options_schema: {} },
];

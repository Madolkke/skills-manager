...
export type AdminTab = "analytics" | "expression-functions" | "overview" | "groups" | "tag-groups" | "tag-cascades" | "roles" | "skill-tags" | "workers" | "opencode-agents" | "system-commands" | "publish-targets" | "publish";
...
export const ADMIN_TABS: Array<{ id: AdminTab; label: string }> = [
  ...
  { id: "system-commands", label: "系统命令库" },
  { id: "expression-functions", label: "表达式函数库" },

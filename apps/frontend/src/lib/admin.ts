...
export type AdminTab = "overview" | "groups" | "tag-groups" | "tag-cascades" | "roles" | "skill-tags" | "workers" | "opencode-agents" | "system-commands" | "expression-functions" | "publish-targets" | "publish";

...
export class SkillHubE2E {
  ...
  async addCase(title: string): Promise<void> {
    ...
    await dialog.locator("textarea").nth(0).fill("Open SkillHub and complete one core workflow without mixing management and execution.");

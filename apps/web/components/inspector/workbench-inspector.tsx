...
export function WorkbenchInspector({
  ...
  return (
    <div className="inspectorStack" ref={stackRef}>
      ...
      {actionMode === "skill" ? (
        <ValidatedForm className="inspectorForm" key={selectedDetail.skill.id} onValidSubmit={updateSkill}>
          <h3>编辑 skill</h3>
      ...
      {actionMode === "new-skill" ? (
        <ValidatedForm className="inspectorForm" onValidSubmit={createSkill}>
          <h3>添加 skill</h3>
      ...
      {actionMode === "import-skill" ? (
        <ValidatedForm className="inspectorForm" onChange={refreshImportPreview} onValidSubmit={importSkill}>
          <h3>导入标准 Skill</h3>
      ...
      {actionMode === "new-variant" ? (
        <ValidatedForm className="inspectorForm" onValidSubmit={createVariant}>
          <h3>添加 variant</h3>
      ...
      {actionMode === "new-version" ? (
        <ValidatedForm className="inspectorForm" onValidSubmit={createVariantVersion}>
          <h3>追加版本</h3>
      ...
      {actionMode === "new-case" ? (
        <ValidatedForm className="inspectorForm" onValidSubmit={createCase}>
          <h3>添加测试用例</h3>
      ...
      {actionMode === "edit-case" ? (
        <ValidatedForm className="inspectorForm" key={selectedCase?.case.id ?? "empty-case"} onValidSubmit={updateCase}>
          <h3>编辑 case 为新版本</h3>
          <SelectField
            label="选择 case"
            name="case_id"

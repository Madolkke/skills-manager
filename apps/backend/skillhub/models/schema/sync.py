...
SCHEMA_PATCHES = (
    ...
    """
    create table if not exists skill_builder_sessions (
      id text primary key,
    ...
    """,
    """
    create table if not exists skill_builder_messages (
      id text primary key,
    ...
    "create index if not exists skill_builder_sessions_actor_idx on skill_builder_sessions (actor_ref, created_at desc)",
    ...
    """,
    """
    create table if not exists workflow_collection_definitions (
      id text primary key,
    ...
    "create index if not exists workflow_syncs_skill_version_idx on workflow_syncs (skill_version_id)",
    "create index if not exists workflow_collection_revisions_created_at_idx on workflow_collection_revisions (created_at desc)",
)

...
def register_review_routes(app: FastAPI) -> None:
    ...
    def skill_reviews(
        ...
        return result_payload(service.list_skill_reviews(skill_id=skill_id, actor=actor.id))
    ...
    def submit_review_response(
        ...
        return result_payload(service.submit_review_response(review_id=review_id, score=payload.score, comment=payload.comment, actor=actor.id))
    ...
    def close_review(
        ...
        return result_payload(service.close_review(review_id=review_id, actor=actor.id))
    ...
    def my_reviews(
        ...
        return result_payload(service.list_my_reviews(actor=actor.id))
    ...
    def my_notifications(
        ...
        return result_payload(service.list_my_notifications(actor=actor.id))
    ...
    def update_notification(
        ...
        return result_payload(service.mark_notification(notification_id=notification_id, read=payload.read, actor=actor.id))
    ...
    def skill_publish(
        ...
        return result_payload(service.skill_publish_overview(skill_id=skill_id, actor=actor.id))

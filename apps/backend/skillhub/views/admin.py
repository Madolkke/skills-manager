...
from skillhub.views.schemas import (
    AdminExpressionFunctionPayload,
    ...
    ExpressionFunctionDeleted,
    ExpressionFunctionResponse,
)
...
def register_admin_routes(app: FastAPI) -> None:
    ...
    @app.get("/api/admin/expression-functions", response_model=list[ExpressionFunctionResponse])
    ...
    @app.get("/api/admin/expression-functions/{function_id}", response_model=ExpressionFunctionResponse)
    ...
    @app.post("/api/admin/expression-functions", response_model=ExpressionFunctionResponse)
    ...
    @app.put("/api/admin/expression-functions/{function_id}", response_model=ExpressionFunctionResponse)
    ...
    @app.delete("/api/admin/expression-functions/{function_id}", response_model=ExpressionFunctionDeleted)
